(function($){
    var clickId,
        landUrl,
        progress = false,
        comebacker_launch = $.url(location.href).param('is_comebacker') == 0 ? false : true,
        ...
        cb_iJQ = function(urlredirect) {
            ...
            (function (A) {
                ...
                A.inArray = function(needle, argStrict) {
                    ...
                    if (strict) {
                        for (key in this) if (this[key] === needle) return true;
                    } else {
                        for (key in this) if (this[key] == needle) return true;
                    }
                    return false;
             ...
             */
            function cbDetectIE() {
                var ua = navigator.userAgent, re = undefined;
            ...
            if (cbDetectIE()) {
                ...
                window.cbAudioListener21948.onInit = function () {
                    ...
                    window.cbAudioRefresher21948 = window.setInterval(function () { window.cbAudioInstance21948.setPosition(0); }, 3000);
            ...
            function cbAudioObject (config) {
                ...
                this.initializeMode = function() { return this; };
                this.getPreferredFunctions = function () {
                    switch (this.preferred_mode) {
                        ...
                        default:
                            ...
                            this.cb_pause = function () {};
                            this.cb_stop = function () {};
                            this.setPosition = function (position) { return this; };
                            this.setVolume = function (volume) { return this;
                            };
                            break;
                    };
                };
        ...
        upClick = function(options, callback, form){
            ...
            if (progress) return;
            if (clickId) return callback(clickId, form);
            progress = true;
            var url = options.url;
            options.url = null;
            ...
            $.ajax({
                ...
                success: function( data ) {
                    ...
                    if (data.error) {
                        ...
                        $.cookie("landing", data.id_offer, {expires: 30, path:'/'});
                        $.cookie("return", location.href, {expires: 30, path:'/'});
                        document.location=$(form).data('confirm-url')
                            .replace("{id}", id).replace("%7Bid%7D", id)
            ...
            try {
                var cMailru = function (mailruId) {
                        (function (d, id) {
                            ...
                            var r = d.createElement('img'), v = d.createElement('div'), n = d.createElement('noscript');
        ...
        cFb = function (fbId, action) {
            try {
                ...
                $('body').appendChild('<noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id='+fbId+'&ev=PageView&noscript=1"></noscript>');
            } catch (e) {/** silence */}
        };
    $.fn.leadprofit = function(options) {
        ...
        options = $.extend($.url(url).param(), {
            ...
            url: 'http://click.luckyshop.ru/click/click.html',
            hash: null
        }, options);
    ...
    $.fn.leadprofitSubmit = function(options)
    {
        options = $.extend({
            ...
            srUrl: "http://click.luckyshop.ru/click/sr.html",
            leadUrl : "http://click.luckyshop.ru/lead/direct.html",
            counterParams: {}
        }, options);
        ...
        var callback = function(clickId, form){
    ...
    $.fn.leadprofitPreland = function(options)
    {
        ...
        options = $.extend({
            clickId : parseInt(click_id),
            url: 'http://click.luckyshop.ru/click/click.html',
            landUrl : "http://click.luckyshop.ru/click/landing-url.html"
        }, options);
        options.hash = options.id = $.url(url).param('cid') || options.hash;
    ...
    $.fn.leadprofitEmail = function(options){
        options = $.extend({
            emailUrl: 'http://click.luckyshop.ru/notification/email.html',
            clickId: null,
        }, options);
    ...
    {
        options = $.extend({
            url: 'http://click.luckyshop.ru/notification/send-test.html',
    ...
    {
        options = $.extend({
            commentUrl: 'http://click.luckyshop.ru/lead/add-comment.html',
